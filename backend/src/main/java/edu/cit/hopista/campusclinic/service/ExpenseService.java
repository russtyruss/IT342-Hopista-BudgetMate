...
import edu.cit.hopista.campusclinic.dto.request.ExpenseRequest;
import edu.cit.hopista.campusclinic.dto.response.ExpenseResponse;
import edu.cit.hopista.campusclinic.entity.Budget;
import edu.cit.hopista.campusclinic.entity.Expense;
import edu.cit.hopista.campusclinic.entity.User;
import edu.cit.hopista.campusclinic.exception.BadRequestException;
import edu.cit.hopista.campusclinic.exception.ResourceNotFoundException;
import edu.cit.hopista.campusclinic.repository.BudgetRepository;
import edu.cit.hopista.campusclinic.repository.ExpenseRepository;
import edu.cit.hopista.campusclinic.repository.UserRepository;
import edu.cit.hopista.campusclinic.websocket.DashboardNotificationService;
...
public class ExpenseService {
    ...
    private Budget getLinkedBudget(Long userId, Long budgetId, java.time.LocalDate expenseDate) {
        ...
        if (budget.getStartDate() != null
            ...
            && (expenseDate.isBefore(budget.getStartDate()) || expenseDate.isAfter(budget.getEndDate()))) {
