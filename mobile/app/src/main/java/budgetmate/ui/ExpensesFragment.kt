...
class ExpensesFragment : Fragment() {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            viewLifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                vm.uiState.collect { state ->
                    ...
                    rowAdapter.submit(state.expenses, state.budgets, state.selectedCurrency, state.exchangeRates)
    ...
    private class ExpenseRowAdapter(
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
            ...
            val converted = convertAmount(item.amount, item.currency, selectedCurrency, exchangeRates)
