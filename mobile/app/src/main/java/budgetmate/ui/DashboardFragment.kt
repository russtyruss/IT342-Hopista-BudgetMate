...
class DashboardFragment : Fragment() {
    ...
    private fun convertAmount(amount: Double, fromCurrency: String?, toCurrency: String, state: AppUiState): Double {
    ...
    private inner class RecentExpenseAdapter : BaseAdapter() {
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
            ...
            val converted = convertAmount(item.amount, item.currency, selectedCurrency, state)
    ...
    private inner class BudgetStatusAdapter : BaseAdapter() {
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
            ...
            val state = uiState ?: return view
            val item = items[position]
            val convertedLimit = convertAmount(item.limitAmount, item.currency, selectedCurrency, state)
            val convertedSpent = convertAmount(item.spentAmount, item.currency, selectedCurrency, state)
